...
import com.wz.wtxyd.ui.widget.animation.AnimationProvider;
import com.wz.wtxyd.ui.widget.animation.CoverAnimation;
import com.wz.wtxyd.ui.widget.animation.NoneAnimation;
import com.wz.wtxyd.ui.widget.animation.SimulationAnimation;
import com.wz.wtxyd.ui.widget.animation.SlideAnimation;
...
public class PageWidget extends View {
    ...
    private void initPage(){
        mScreenWidth = DensityUtil.getScreenW();
        mScreenHeight = DensityUtil.getScreenH();
...
//        canvas.drawColor(0xFFAAAAAA);
        canvas.drawColor(getResources().getColor(R.color.material_red));
